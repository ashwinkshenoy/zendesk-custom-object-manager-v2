...
const ObjectRecordSearch = {
  ...
  methods: {
     ...
     */
    generateCSV(records) {
      let columnHeaders = [...this.filteredColumns].sort();
      columnHeaders = ['created_at', 'id', 'name', ...this.filteredColumns, 'external_id'];
